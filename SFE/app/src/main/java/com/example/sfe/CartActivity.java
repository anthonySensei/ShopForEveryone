...
import com.example.sfe.Model.Cart;
import com.example.sfe.Prevalent.Prevalent;
import com.example.sfe.ViewHolder.CartViewHolder;
import com.example.sfe.config.Config;
...
public class CartActivity extends AppCompatActivity {
    ...
    private void processPayment() {
        ...
        PayPalPayment payPalPayment = new PayPalPayment(new BigDecimal(String.valueOf(overTotalPrice)), "USD",
                "payment for the goods", PayPalPayment.PAYMENT_INTENT_SALE);
