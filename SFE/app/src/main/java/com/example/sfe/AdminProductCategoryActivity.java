...
import com.example.sfe.Admin.AdminCategoryActivity;
...
public class AdminProductCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchList = findViewById(R.id.admin_products_of_certain_category_list);
        categoryName = getIntent().getExtras().get("category").toString();
        searchList.setLayoutManager(new LinearLayoutManager(AdminProductCategoryActivity.this));
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull final Products model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Intent intent =new Intent(AdminProductCategoryActivity.this, AdminMaintainProductsActivity.class);
